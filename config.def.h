...
static const char *fonts[] = {"Iosevka Nerd Font:size=14:antialias=true:autohint=true"};
...
static const char *cmuscmd[] = {"spotify", NULL};
...
static Key keys[] = {
	...
	{MODKEY, XK_p, spawn,
		SHCMD("qdbus org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.PlayPause && pkill -RTMIN+20 dwmblocks")},
	{MODKEY, XK_bracketleft, spawn,
		SHCMD("qdbus org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Previous && pkill -RTMIN+20 dwmblocks")},
	{MODKEY, XK_bracketright, spawn,
		SHCMD("qdbus org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Next && pkill -RTMIN+20 dwmblocks")},
	{0, XK_Print, spawn,
		SHCMD("/usr/bin/flameshot gui")},
