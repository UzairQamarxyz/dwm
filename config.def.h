...
static const char *fonts[] = {
    "Noto Sans:pixelsize=13",
    "Material Design Icons:Regular:pixelsize=13:antialias=true"};
...
static const char *tags[] = {" 󰅪 ", " 󰇧 ", " 󰉋 ", " 󰝚 ", " 󰎁 ", " 󰺵 ", " 󱔗 "};
/*"  \ue1ec", "  \ue26d", "  \ue1e0", "  \ue05c",
"  \ue1dd", "  \ue19a", "  \ue1ed"};  If using siji add 2 spaces before tag name
to center them */
