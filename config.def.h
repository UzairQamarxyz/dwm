...
static Key keys[] = {
    ...
    { MODKEY,			    XK_Print,	             spawn,	SHCMD("maim -u -s -l -c 0.157,0.333,0.466,0.4 ~/Pictures/screenshots/$(date +%s).png") },
    ...
    { 0,		        	XK_Print,	             spawn,	SHCMD("maim -u -s -l -c 0.157,0.333,0.466,0.4 | xclip -selection clipboard -t image/png") },
